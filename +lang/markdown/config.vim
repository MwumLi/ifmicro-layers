...
" markdown-preview.vim {
    ...
    autocmd LAYERVIM_MARKDOWN FileType markdown nnoremap <LocalLeader>cp :MarkdownPreview<cr>
    " Generate markdown TOC
    autocmd LAYERVIM_MARKDOWN FileType markdown nnoremap <LocalLeader>ct :silent GenTocGFM<cr>
    " Show toc sidebar
    autocmd LAYERVIM_MARKDOWN FileType markdown nnoremap <LocalLeader>cs :Toc<cr>
